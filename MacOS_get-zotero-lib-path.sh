...
if [ ${#json_files[@]} -eq 0 ]; then
  echo -e '\n→ Файл библиотеки Zotero в формате JSON не найден 🤔. Экспортируйте библиотеку из Zotero, как это показано в уроке 1.5. Чтобы перейти на платформу и посмотреть урок, нажмите Enter. Для отмены нажмите Esc.'
